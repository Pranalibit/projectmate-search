      ...
      <div className=" w-full lg:max-w-full lg:flex mx-auto">
        <div className="border-r border-b border-l w-full border-gray-400 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between">
          <div className="mb-8 min-w-full">
            ...
            {/* <div className="text-gray-700 text-sm font-semibold font-Sora">{roles}</div> */}
          </div>
          <div className="flex justify-between">
            ...
            </div>'<p><a href="mailto:someone@example.com"><button className=" relative flex justify-evenly items-center z-10 bg-white border rounded-md p-1 opacity-75 hover:opacity-100 focus:outline-none focus:border-gray-500">
              <span className="inline-block text-sm px-1 text-gray-600">Message</span>
              <svg
